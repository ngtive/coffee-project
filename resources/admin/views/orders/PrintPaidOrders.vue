    ...
    <div class="container" v-loading="loading">
        <div class="row border-bottom">
            ...
            <div class="col-6 mb-2" dir="ltr">
                <a href="/admin/orders/change-paid-to-printed" target="_blank" class="btn btn-primary">
        ...
        <div class="row mt-3 panel">
            <div class="col-12 border-bottom row">
                ...
                <div class="col-12 row p-0 mb-3" dir="ltr">
                    <div class="col-12 col-md-2">
                        <button class="btn btn-secondary" @click="clickSendSelected" :disabled="!anythingChecked">
                            <em class="fa fa-truck"></em>
                            ارسال
                        </button>
                    </div>
                    <div class="col-12 col-md-2 mt-2 mt-md-0">
                        <button class="btn btn-primary" @click="clickPrintSelected" :disabled="!anythingChecked">
                            <em class="fa fa-print"></em>
                            پرینت
                        </button>
                    </div>
            ...
            <div class="col-12 mt-3 text-center" v-if="paid_orders.length <= 0">
