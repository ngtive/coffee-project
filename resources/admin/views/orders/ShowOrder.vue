<template>
    <div class="container" v-loading="loading">
        ...
        <div class="row mt-3">
            <div class="col-12 col-md-6 panel" id="receiptDescription">
                <div class="row">
                    ...
                    <div class="col-12 mt-3">
                        <p>
                            ...
                            <span v-else
                                  style="font-size: 20px;"
                                  class="text-success fa fa-check"></span>
                        </p>
                    </div>
                    ...
                    <div class="col-12 mt-3">
                        <router-link tag="a" class="user-anchor" :to="{name: 'user', params: {id: order.user_id}}">{{ order.address.first_name }} {{ order.address.last_name }}</router-link>
                    </div>
                    ...
                    <div class="col-12 mt-1">
                        <p>شماره مرجع: <span>{{ order.reference_number ? order.reference_number : 'شماره مرجع وجود ندارد'}}</span></p>
                    </div>
                    <div class="col-12 mt-1">
                        <p>تاریخ پرداخت: <span dir="ltr">{{ order.accepted_at ? order.accepted_at : 'تاریخ پرداخت وجود ندارد' }}</span></p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-5 panel ms-md-1 mt-md-0 mt-1">
                <div class="row">
                    ...
                    <div class="col-12 mt-1" v-for="item in order.items" v-if="order.items.length > 0">
