<template>
    <div class="container">
        ...
        <form v-loading="loading" class="row mt-4 panel" @submit.prevent="submitUpdate">
            <div class="row">
                <div class="col-md-6 col-lg-2">
                    <label class="form-label" for="first_name">نام</label>
                </div>
                <div class="col-md-6 col-lg-4">
                    <input id="first_name" v-model="user.first_name" class="form-control" placeholder="نام">
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-6 col-lg-2">
                ...
                <div class="col-md-6 col-lg-4">
                    <input id="last_name" v-model="user.last_name" class="form-control" placeholder="نام خانوادگی">
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-6 col-lg-2">
                ...
                <div class="col-md-6 col-lg-4">
                    <input id="phone_number" v-model="user.phone_number" class="form-control"
        ...
        <div class="row mt-3 panel">
            ...
            <div class="col-12 mt-2">
                <div v-for="address in user.addresses" :class="{'address-default': address.default != '0'}"
                     class="address-wrapper mt-1">
